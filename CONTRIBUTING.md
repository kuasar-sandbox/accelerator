...
Open a pull request from `<your-login>/accelerator:feat/short-description` to `kuasar-sandbox/accelerator:main`. Enable **Allow edits from maintainers** when appropriate.
