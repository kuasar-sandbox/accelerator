...
//
// The service exposes counter-only statistics: hits/misses/fills at
// three layers — wire-handler (daemon external view), TieredCache
// (per-tier cascade), and shardImpl (per-EC-peer). Daemon latency is
// not collected; clients measure end-to-end latency themselves.
