...
func (l RefLocations) Set(spec string) error {
	...
	probe := Ref{Scheme: RefSchemeFile, Path: "probe", Location: name}
...
func (l RefLocations) ResolveFile(ref Ref, relativeDir string) (string, error) {
	if ref.Scheme != RefSchemeFile {
