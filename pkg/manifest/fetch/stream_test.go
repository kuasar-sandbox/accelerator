...
func newTestManifestStream(m *codec.Manifest, keys [][32]byte, getter cache.Getter, dec crypto.Decryptor) Stream {
	...
	return newManifestStream(m, keys, onDemand, prefetch, dec)
}
